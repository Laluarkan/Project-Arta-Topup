    ...
    <div className="flex-1 overflow-y-auto bg-white flex flex-col">
      ...
      <div className="px-8 py-12 bg-gradient-to-b from-violet-50 to-white border-b-2 border-ink/5">
        <div className="max-w-4xl mx-auto">
          <h1 className="font-display font-700 text-4xl mb-3 text-center">Syarat & Ketentuan</h1>
      ...
      <div className="px-8 py-10 max-w-4xl mx-auto w-full flex-1">
        <div className="card p-8 bg-white space-y-6 text-sm text-ink/80">
          <p>
            Selamat datang di ArTa Zone. Dengan mengakses dan menggunakan platform kami, Anda menyetujui untuk terikat dengan Syarat dan Ketentuan berikut. Mohon baca dengan saksama sebelum melakukan transaksi.
          </p>

          <div>
            <h2 className="font-display font-700 text-lg mb-2 text-ink">1. Definisi</h2>
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li><strong>ArTa Zone:</strong> Platform penyedia layanan top-up game dan produk digital.</li>
              <li><strong>Pengguna:</strong> Pihak yang mengakses situs atau melakukan pembelian produk di ArTa Zone.</li>
              <li><strong>Produk:</strong> Item virtual, mata uang in-game, atau voucher yang dijual di platform.</li>
            </ul>
          </div>

          <div>
            <h2 className="font-display font-700 text-lg mb-2 text-ink">2. Ketentuan Transaksi</h2>
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>Harga yang tertera dapat berubah sewaktu-waktu tanpa pemberitahuan sebelumnya mengikuti kebijakan pihak penyedia.</li>
              <li>Pengguna <strong>wajib memastikan ID Game/Nomor Tujuan</strong> yang dimasukkan adalah benar. Kesalahan pengisian ID sepenuhnya menjadi tanggung jawab Pengguna.</li>
              <li>Transaksi yang sudah berstatus SUKSES tidak dapat dibatalkan atau dikembalikan dengan alasan apapun.</li>
            </ul>
          </div>

          <div>
            <h2 className="font-display font-700 text-lg mb-2 text-ink">3. Kebijakan Pengembalian Dana (Refund)</h2>
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>Jika transaksi berstatus GAGAL dari sisi server kami, sistem <em>Auto-Refund</em> akan otomatis mengembalikan dana penuh ke Saldo Wallet Pengguna.</li>
              <li>Pengembalian dana ke rekening bank/E-Wallet asli dapat memakan waktu 1-3 hari kerja dan harus diajukan melalui Tiket Komplain.</li>
              <li>Dana tidak akan dikembalikan jika transaksi sukses masuk ke ID Game yang salah akibat kelalaian pembeli.</li>
            </ul>
          </div>

          <div>
            <h2 className="font-display font-700 text-lg mb-2 text-ink">4. Keamanan Akun & Larangan</h2>
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>Pengguna bertanggung jawab penuh atas kerahasiaan kata sandi akun ArTa Zone miliknya.</li>
              <li>Dilarang menggunakan platform ini untuk tindakan penipuan, pencucian uang, atau aktivitas ilegal lainnya. ArTa Zone berhak memblokir akun yang terindikasi melakukan pelanggaran.</li>
            </ul>
          </div>

          <p className="pt-4 border-t-2 border-ink/10 text-xs italic">
            ArTa Zone berhak mengubah, memodifikasi, menambah, atau menghapus bagian-bagian dari Syarat & Ketentuan ini sewaktu-waktu. Kebijakan yang berlaku adalah kebijakan yang tertera di halaman ini pada saat transaksi dilakukan.
          </p>

          <div className="mt-10 pt-8 border-t-2 border-ink/10">
            <h2 className="font-display font-700 text-lg mb-4 text-ink text-center">Punya Pertanyaan Terkait Ketentuan Kami?</h2>
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <a href="mailto:lalunaufalarkan21@gmail.com" className="card-sm p-4 flex items-center gap-4 hover:-translate-y-1 transition cursor-pointer bg-white group border border-ink/10">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-ink/60">Kendala bisnis</p>
                </div>
              </a>
            </div>
          </div>
