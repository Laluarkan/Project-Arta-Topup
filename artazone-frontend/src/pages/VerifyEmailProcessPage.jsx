      ...
      <div className="p-8 bg-white rounded-lg shadow-md max-w-md w-full text-center">
        ...
        {status === 'success' && (
          <div className="flex flex-col items-center">
            ...
            <button
              onClick={() => navigate(localStorage.getItem('token') ? '/' : '/auth?verified=1')}
              className="px-6 py-2 bg-violet-600 text-white rounded-md hover:bg-violet-700 transition text-sm"
            >
              Lanjutkan Sekarang
            </button>
          </div>
